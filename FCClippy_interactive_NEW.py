# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# FCClippy_interactive.py
# Created: 05/08/2019
# Updated: 05/15/2019
# Author: Chris Fourroux
# Modified by Mike Murnane on 03/23/2020 for blank spaces in legend layer alias name.
# Usage: FCClippy_interactive <Input_Layers> <outputLocation> <co40>
# <Input_Layers> = multi select Feature Layers that need clipping
# <co40> = clip to shape
# <outputLocation> = path to output that will contain results.
# Description: Iterates through selected layers in map and clips them to new feature layers
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    try:
        ...
        #inLayers = Input_Layers.replace("\'",'') # replace quotes at beginning and end of some strings
        ...
        co40 = arcpy.GetParameterAsText(2)
        if co40 == '#' or not co40:
